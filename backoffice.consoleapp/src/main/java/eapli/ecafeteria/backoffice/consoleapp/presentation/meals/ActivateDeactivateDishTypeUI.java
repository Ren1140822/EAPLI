...
import eapli.ecafeteria.application.meals.ActivateDeactivateDishTypeController;
...
public class ActivateDeactivateDishTypeUI extends AbstractUI {
    ...
    protected boolean doShow() {
        ...
        if (!allDishTypes.iterator().hasNext()) {
            ...
            final SelectWidget<DishType> selector = new SelectWidget<>("Dish types:", allDishTypes, new DishTypePrinter());
            selector.show();
