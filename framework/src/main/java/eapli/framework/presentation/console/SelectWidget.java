...
public class SelectWidget<T> extends ListWidget<T> {
    ...
    public SelectWidget(String header, Collection<T> source) {
	super(header, source);
    }

    public SelectWidget(String header, Iterable<T> source) {
	super(header, source);
    }

    public SelectWidget(String header, Collection<T> source, Visitor<T> visitor) {
	super(header, source, visitor);
    }

    public SelectWidget(String header, Iterable<T> source, Visitor<T> visitor) {
	super(header, source, visitor);
    }
